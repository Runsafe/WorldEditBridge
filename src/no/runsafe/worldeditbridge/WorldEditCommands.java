...
public class WorldEditCommands implements WorldEditInterface
{
	...
	public void select(IPlayer player, ILocation pos1, ILocation pos2)
	{
		...
		final CuboidSelection selection = new CuboidSelection(ObjectUnwrapper.convert(player.getWorld()), pt1, pt2);
		worldEdit.setSelection(ObjectUnwrapper.convert(player), selection);
	}
